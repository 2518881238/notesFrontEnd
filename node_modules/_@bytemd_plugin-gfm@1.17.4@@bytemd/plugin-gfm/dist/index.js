"use strict";
const icons = require("@icon-park/svg");
...
const findAndReplace = function(tree, find, replace2, options) {
  let settings;
  let schema;
...
function gfm({
  ...
  return {
    ...
    actions: [
      {
        title: locale.strike,
        icon: icons__namespace.Strikethrough({}),
      ...
      {
        title: locale.task,
        icon: icons__namespace.CheckCorrect({}),
      ...
      {
        title: locale.table,
        icon: icons__namespace.InsertTable({}),
        handler: {
          type: "action",
